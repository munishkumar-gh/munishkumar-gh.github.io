# -*- coding: utf-8 -*-
"""
Created on Fri May 31 15:15:36 2019
...
class Gantt():
    ...
    def add_milestones(self):
        ...
        The milestones are simple vertical line
        """
        ...
        plt.scatter(x, y, s=250, marker= "|",
                    color="black", edgecolor="black", zorder=3)
...
if __name__ == '__main__':
    g = Gantt('C:\\Users\\J0501553\\AnacondaProjects\\sample.json')
    g.render()
    g.show()
