...
print('Thomeer Parameters Estimated from our Imported HPMI Data:')
print('Pd1 =',Pd1_solve,', G1 =',G1_solve,',   BV1 =',BV1_solve)
print('Pd2 =',Pd2_solve,', G2 =',G2_solve,', BV2 =',BV2       )
print()
...
#        ax = self.figure.add_subplot(411) 
        ...
        ax.loglog(x_Pc, y_Pc, 'g-' , linewidth=5 , label='Closure Corrected Pc Curve')
